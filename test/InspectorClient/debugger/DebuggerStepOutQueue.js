...
const DebuggerStepOutQueue = require('../../../lib/InspectorClient/debugger/DebuggerStepOutQueue');
const StepOutCommand = require('../../../lib/InspectorClient/debugger/commands/StepOutCommand');
const InvalidTypeGivenForCommand = require('../../../lib/InspectorClient/errors/InvalidTypeGivenForCommand');

describe('DebuggerStepOutQueue', function () {
  const id = 0;
  var inst;
  beforeEach(() => inst = new DebuggerStepOutQueue(id));
  after(() => DebuggerStepOutQueue.data().reset());
  describe('Generating new commands', function () {
    it('Should generate instances of StepOutCommand',
      () => assert(inst.newCommand(0, false) instanceof StepOutCommand));
  });
