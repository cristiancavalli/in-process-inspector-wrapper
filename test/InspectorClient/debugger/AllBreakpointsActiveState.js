...
const AllBreakpointsActiveState = require('../../../lib/InspectorClient/debugger/AllBreakpointsActiveState');
const AllBreakpointsActiveCommand = require('../../../lib/InspectorClient/debugger/commands/AllBreakpointsActiveCommand');
const InvalidTypeGivenForCommand = require('../../../lib/InspectorClient/errors/InvalidTypeGivenForCommand');

describe('AllBreakpointsActiveState', function () {
  const id = 0;
  var inst;
  beforeEach(() => inst = new AllBreakpointsActiveState(id));
  after(() => AllBreakpointsActiveState.data().reset());
